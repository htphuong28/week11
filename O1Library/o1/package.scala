/** **O1Library** is a toolkit designed for the course [Programming 1 (a.k.a. O1)](https://plus.cs.aalto.fi/o1/)
  ...
  * implementations. The aliases enable that convenient `import` command. The subpackages
  * contain additional tools beyond what is available via `import o1.*`.
  *
  * O1Library’s student-facing interface was designed by Juha Sorva. Aleksi Lukkarinen, Juha Sorva,
  * and Jaakko Nakaza did the underlying implementation. Several of the key components in `o1.gui`
  * and `o1.world` are built upon Jaakko’s  [SMILe library](https://github.com/Aalto-LeTech/SMILe),
  * which is a refactored and modified version of Aleksi’s [Scala Media Computation Library](https://github.com/Aalto-LeTech/Scala-Media-Computation).
  ...
  * @author Jaakko Nakaza (jaakko.nakaza@aalto.fi) */
package o1
...
/** The `View` type represents GUI windows that graphically represent a given domain model;
  * this is a shortcut alias to class `BasicViewFrame` in `o1.gui.mutable`. */
type View[Model <: AnyRef] = G.mutable.BasicViewFrame
...
/** Creates a picture of a filled rectangle with the given parameters; this is a shortcut
  ...
  * To adjust more parameters, such as the color and width of the shape’s outline, see
  * the additional tools in [[o1.gui.Pic$ `o1.gui.Pic`]]
...
/** Creates a picture of a filled rectangle with the given parameters; this is a shortcut
  * alias to [[o1.gui.Pic$ `o1.gui.Pic`]]. To adjust more parameters, such as the color and
  * width of the shape’s outline, see the additional tools in [[o1.gui.Pic$ `o1.gui.Pic`]]
  * @param width   the width of the rectangle and the picture
  * @param height  the height of the rectangle and the picture
  * @param color   the color of the rectangle and thus the only color visible in the picture
  * @param anchor  the picture’s anchoring point */
def rectangle(width: Double, height: Double, color: Color, anchor: Int): G.Pic =
  G.Pic.rectangle(width, height, color)
...
def square(side: Double, color: Color, anchor: Anchor): G.Pic =
  G.Pic.square(side, color, anchor = anchor)
...
def circle(diameter: Double, color: Color, anchor: Anchor): G.Pic =
  G.Pic.circle(diameter, color, anchor = anchor)


/** Creates a picture of an ellipse with the given parameters; this is a shortcut
  * alias to [[o1.gui.Pic$ `o1.gui.Pic`]]. The picture’s [[Anchor]] is at its center.
  * To adjust more parameters, such as the color and width of the shape’s outline,
  * see the additional tools in [[o1.gui.Pic$ `o1.gui.Pic`]]
...
def ellipse(width: Double, height: Double, color: Color, anchor: Anchor): G.Pic =
  G.Pic.ellipse(width, height, color, anchor = anchor)
...
/** Creates a picture of an isosceles triangle with the given parameters; this is a shortcut
  ...
  * and its apex is at the top center. The picture’s [[Anchor]] is at its center. To adjust
  * more parameters, such as the color and width of the shape’s outline, see the additional
  * tools in [[o1.gui.Pic$ `o1.gui.Pic`]]
...
def triangle(width: Double, height: Double, color: Color): G.Pic =
  G.Pic.isoscelesTriangle(width, height, color)

/** Creates a picture of an isosceles triangle with the given parameters; this is a shortcut
  * alias to [[o1.gui.Pic$ `o1.gui.Pic`]]. The triangle’s base is at the bottom of the picture
  * and its apex is at the top center. To adjust more parameters, such as the color and width
  * of the shape’s outline, see the additional tools in [[o1.gui.Pic$ `o1.gui.Pic`]]
  * @param width     the width of the triangle’s base, which determines the width of the picture, too
  * @param height    the height of the triangle, which determines the height of the picture, too
  * @param color     the triangle’s color
  * @param anchor    an anchor for the new picture */
def triangle(width: Double, height: Double, color: Color, anchor: Anchor): G.Pic =
  G.Pic.isoscelesTriangle(width, height, color, anchor = anchor)
...
def star(width: Double, color: Color, anchor: Anchor): G.Pic =
  G.Pic.star(width, color, anchor = anchor)


/** Creates a picture containing the given textual content. this is a shortcut alias
  * to [[o1.gui.Pic$ `o1.gui.Pic`]]. To adjust more parameters, see the additional
  * tools in [[o1.gui.Pic$ there]].
  ...
  *                 installed on the computer or a default font will be used instead
  * @param size     the font size
  * @param color    the text’s color */
def text(content: String, font: String, size: Double, color: Color): G.Pic =
  G.Pic.text(content, font, size, color)
...
/** Creates a picture containing the given textual content. this is a shortcut alias
  ...
  * @param color    the text’s color
  * @param anchor   an anchor for the new picture */
def text(content: String, font: String, size: Double, color: Color, anchor: Anchor) : G.Pic =
  G.Pic.text(content, font, size, color, anchor = anchor)
...
/** Creates a picture of a thin line defined in terms of two locations on a plane;
  ...
  * against a transparent background. To adjust more parameters, such as the shape
  * of the line’s end points, see the additional tools in [[o1.gui.Pic$ `o1.gui.Pic`]]
  ...
  * @param thickness  the line’s width in pixels; if unspecified, defaults to `1.0` */
def line(from: Pos, to: Pos, color: Color, thickness: Double = 1): G.Pic =
  G.Pic.line(from, to, color, thickness)
...
// NOTE: DOC STILL DOES NOT GET GENERATED (8/2024)
/** This extension adds some methods to Swing’s `InputEvent` class;
